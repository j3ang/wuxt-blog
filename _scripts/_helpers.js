module.exports = {
  ...
  checkWPCli: function (container, done) {
    var exec = require("child_process").exec;
    exec(
      "docker exec " + container + " bash -c 'wp'",
    ...
    this.getArgs(
      ...
      function (err, result) {
        ...
        var env =
          ...
          result["port-dist"] +
          "\n" +
          "WUXT_MYSQL_CONTAINER=mysql." +
          result["project"] +
          "\n" +
          "WUXT_WP_CONTAINER=wp." +
          result["project"] +
          "\n" +
          "WUXT_NUXT_CONTAINER=front." +
          result["project"] +
          "\n";
          ...
          function (error, stdout, stderr) {
            if (!error) {
              mkdirp("./wp-content/themes/wuxt/cpts", function (err) {
                ...
                fs.writeFile(
                  "./wp-content/themes/wuxt/cpts/" + slug + ".php",
                  stdout,
                  function (err) {
                    if (err) {
                      console.log(
          ...
          function (error, stdout, stderr) {
            if (!error) {
              mkdirp("./wp-content/themes/wuxt/taxonomies", function (err) {
                ...
                fs.writeFile(
                  "./wp-content/themes/wuxt/taxonomies/" + slug + ".php",
                  stdout,
                  function (err) {
                    if (err) {
                      console.log(
